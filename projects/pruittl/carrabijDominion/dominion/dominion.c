...
int playAdventurer(int *drawntreasure, int *currentPlayer, struct gameState *state, int *temphand, int *z, int *cardDrawn){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    {
        case adventurer:
            rc = playAdventurer(&drawntreasure, &currentPlayer, state, temphand, &z, &cardDrawn);
            return rc;
            
        case council_room:
            rc = playCouncilRoom(&currentPlayer, state, &handPos);
            return rc;
            
        case feast:
            rc = playFeast(&currentPlayer, state, temphand, &choice1, &x);
            return rc;
        ...
        case mine:
            rc = playMine(&currentPlayer, state, &choice1, &choice2, &j, &handPos);
            return rc;
        ...
        case smithy:
            rc = playSmithy(&currentPlayer, state, &handPos);
            return rc;
